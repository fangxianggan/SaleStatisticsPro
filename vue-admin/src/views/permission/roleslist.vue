    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="角色名称">
          <el-input v-model="filterModel.roleName.value" placeholder="角色名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
      ...
      handleDelete(row, index) {
        ...
        this.$confirm(title, '提示', {
          ...
          .then(() => {
            ...
            this.$ajax("/Role/GetIsDeleteFlag", { code: row.roleCode }, { method: "get" }).then(d => {
              if (d.resultSign == 1) {
