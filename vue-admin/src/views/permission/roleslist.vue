<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="角色名称">
          <el-input
            v-model="filterModel.roleName.value"
            placeholder="角色名称"
            style="width: 200px;"
            class="filter-item"
    ...
    >
      <el-table-column label="角色名称" prop="roleName" sortable="custom" width="180">
      ...
      <el-table-column label="操作" width="250" class-name="small-padding fixed-width">
        <template slot-scope="{row,$index}">
          ...
          <el-button type="success" size="mini" @click="handlePermission(row)">配置权限</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="temp" label-position="right" label-width="100px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="角色编码" prop="roleCode" :rules="rules.checkNull">
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogPermissionVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="permissionData()">保存</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    ...
    data.dialogPermissionVisible = false;
    data.treeData = [];
    data.defaultProps = {
      children: "children",
      label: "label"
