<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="品牌名称">
          <el-input v-model="filterModel.brandName.value" placeholder="品牌名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column label="品牌名称" prop="brandName" sortable="custom" width="180">
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm"  :model="temp" label-position="right" label-width="100px" >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="品牌编码">
              <el-input v-model="temp.brandCode" :readonly="true" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="品牌名称" prop="brandName" :rules="rules.checkNull">
...
<script>
  ...
  export default {
    ...
    data() {
      let custRules = {};
      data.rules = $.extend(true, myAction.setBaseValidateRules(), custRules);
      return data
    },
    created() {
      this.getList()
    ...
    methods: {
      ...
      resetTemp() {
        let brandCode = myAction.newGuid();
        this.temp = {
          id: "",
          brandCode: brandCode,
          brandName: "",
