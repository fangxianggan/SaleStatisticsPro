<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="产品分类名称">
          <el-input v-model="filterModel.categoryName.value" placeholder="产品分类名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column label="产品分类名称" prop="categoryName" sortable="custom" width="180">
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm"  :model="temp" label-position="right" label-width="120px" >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="产品分类编码">
              <el-input v-model="temp.categoryCode" :readonly="true" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="产品分类名称" prop="categoryName" :rules="rules.checkNull">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      resetTemp() {
        let categoryCode = myAction.newGuid();
        this.temp = {
          id: "",
      ...
      handleDelete(row, index) {
        ...
        this.$confirm(title, '提示', {
          ...
          .then(() => {
            ...
            this.$ajax("/Category/GetIsDeleteFlag", { code: row.categoryCode }, { method: "get" }).then(d => {
              if (d.resultSign == 1) {
                myAction.getNotifyFunc(d, this);
                return false;
              }
              let url = "/Category/_DelData"
              let data = { "id": row.id }
