<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="供应商名称">
          <el-input v-model="filterModel.businessName.value" placeholder="供应商名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column label="供应商名称" prop="businessName" sortable="custom" width="180">
    ...
    <el-dialog  v-el-drag-dialog  :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm"  :model="temp" label-position="right" label-width="100px" >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="供应商编码">
              <el-input v-model="temp.businessCode" :readonly="true" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="供应商名称" prop="businessName" :rules="rules.checkNull">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      resetTemp() {
        let businessCode = myAction.newGuid();
        this.temp = {
          id: "",
      ...
      handleDelete(row, index) {
        ...
        this.$confirm(title, '提示', {
          ...
          .then(() => {
            this.$ajax("/Business/GetIsDeleteFlag", { code: row.businessCode }, { method: "get" }).then(d => {
              if (d.resultSign == 1)
              {
                myAction.getNotifyFunc(d, this);
                return false;
              }
              let url = "/Business/_DelData"
              let data = { "id": row.id }
