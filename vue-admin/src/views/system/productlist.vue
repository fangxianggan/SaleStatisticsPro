    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="产品名称">
          <el-input v-model="filterModel.productName.value" placeholder="产品名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible" >
      <el-form ref="dataForm" :model="temp"  label-position="right" label-width="100px" >
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="产品分类" prop="categoryCode" :rules="rules.checkNull">
              <el-select v-model="temp.categoryCode" clearable filterable placeholder="请选择产品分类" @focus="getcategoryCodeSList">
                <el-option v-for="(item,index) in categoryCodeSList"
                           :key="index"
                           :label="item.label"
                           :value="item.value">
        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="备注信息">
              <el-input v-model="temp.remark" placeholder="请输入备注信息" type="textarea" :autosize="{minRows: 2,maxRows: 5}" />
            </el-form-item>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(row) {
        ...
        this.dialogFormVisible = true
        this.categoryCodeSList = [{ label: this.temp.categoryName, value: this.temp.categoryCode }]
        this.$nextTick(() => {
          this.$refs['dataForm'].clearValidate()
        })
      },
      ...
      handleDelete(row, index) {
        ...
        this.$confirm(title, '提示', {
          ...
          .then(() => {
            ...
            this.$ajax("/Product/GetIsDeleteFlag", { code: row.productCode }, { method: "get" }).then(d => {
              if (d.resultSign == 1) {
