<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="配置名称" prop="value" sortable="custom" width="180">
        <template slot-scope="{row}">
          <span>{{ row.value }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="temp" label-position="right" label-width="100px">
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="配置名称" prop="value" :rules="rules.checkNull">
...
export default {
  ...
  methods: {
    getList() {
      ...
      var url = "/SysConfig/_GetPageList";
    ...
    resetTemp() {
      let SysConfigCode = myAction.newGuid();
      this.temp = {
        configId: "",
        code: "",
        value: "",
