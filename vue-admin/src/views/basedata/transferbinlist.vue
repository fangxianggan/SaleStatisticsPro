  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-form :inline="true" :model="filterModel">
        <el-form-item label="转运仓名称">
          <el-input v-model="filterModel.transferBinName.value" placeholder="转运仓名称" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter" />
        </el-form-item>
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column label="转运仓名称" prop="transferBinName" sortable="custom" width="180">
    ...
    <el-dialog v-el-drag-dialog :title="dialogTitle" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm"  :model="temp" label-position="right" label-width="100px" >
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="转运仓编码">
              <el-input v-model="temp.transferBinCode" :readonly="true" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="转运仓名称" prop="transferBinName" :rules="rules.checkNull">
              <el-input v-model="temp.transferBinName" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  export default {
    ...
    methods: {
      getList() {
        ...
        var url = "/TransferBin/_GetPageList"
      ...
      resetTemp() {
        let transferBinCode = myAction.newGuid();
        this.temp = {
          id: "",
          transferBinCode: transferBinCode,
          transferBinName: "",
          createTime: "",
          createUserCode: "",
          updateTime: "",
      ...
      handleDelete(row, index) {
        ...
        this.$confirm(title, '提示', {
          ...
          .then(() => {
            ...
            this.$ajax("/TransferBin/GetIsDeleteFlag", { code: row.transferBinCode }, { method: "get" }).then(d => {
              if (d.resultSign == 1) {
                myAction.getNotifyFunc(d, this);
                return false;
              }

              let url = "/TransferBin/_DelData"
              let data = { "id": row.id }
