    ...
    public class Program
    {
        public static void Main(string[] args)
        {
          //  Test();
            ...
            string str1 = redis.StringGet1("name");//结果：苍
            ...
            string name = redis.StringGet1("name");
            string age = redis.StringGet1("age");
            ...
            batch.Execute();
            Task.WaitAll(t1, t2);
            Console.WriteLine("Age:" + redis.StringGet1("age"));
            Console.WriteLine("Name:" + redis.StringGet1("name"));
