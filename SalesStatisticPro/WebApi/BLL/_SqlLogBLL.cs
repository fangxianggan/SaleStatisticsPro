...
namespace WebApi.BLL
{
    ...
    ///   业务访问——SqlLog
    /// </summary>
    public partial class SqlLogBLL :ISqlLogBLL
    { 
       private readonly ILogic<SqlLog> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public SqlLogBLL(ILogic<SqlLog> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<SqlLog> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SqlLog>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SqlLog>> GetList(Expression<Func<SqlLog, bool>> whereLambda)
        {
