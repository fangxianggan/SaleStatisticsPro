...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<Product> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public ProductBLL(ILogic<Product> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<Product> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Product>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Product>> GetList(Expression<Func<Product, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<Product> SaveData(Product entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Product>> SaveData(List<Product> entityList)
        {
