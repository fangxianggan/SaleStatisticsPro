...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<Menu> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public MenuBLL(ILogic<Menu> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<Menu> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Menu>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Menu>> GetList(Expression<Func<Menu, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<Menu> SaveData(Menu entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Menu>> SaveData(List<Menu> entityList)
        {
