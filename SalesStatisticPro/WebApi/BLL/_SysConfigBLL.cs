...
// </auto-generated>
//
// <copyright file="SysConfigBLL.cs">
...
namespace WebApi.BLL
{
    ...
    ///   业务访问——SysConfig
    /// </summary>
    public partial class SysConfigBLL :ISysConfigBLL
    { 
       private readonly ILogic<SysConfig> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public SysConfigBLL(ILogic<SysConfig> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<SysConfig> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SysConfig>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SysConfig>> GetList(Expression<Func<SysConfig, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<SysConfig> SaveData(SysConfig entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SysConfig>> SaveData(List<SysConfig> entityList)
        {
