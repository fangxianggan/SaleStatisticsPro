...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<PurchaseOrder> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public PurchaseOrderBLL(ILogic<PurchaseOrder> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<PurchaseOrder> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<PurchaseOrder>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<PurchaseOrder>> GetList(Expression<Func<PurchaseOrder, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<PurchaseOrder> SaveData(PurchaseOrder entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<PurchaseOrder>> SaveData(List<PurchaseOrder> entityList)
        {
