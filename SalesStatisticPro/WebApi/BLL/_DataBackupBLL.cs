...
// </auto-generated>
//
// <copyright file="DataBackupBLL.cs">
...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<DataBackup> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public DataBackupBLL(ILogic<DataBackup> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<DataBackup> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<DataBackup>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<DataBackup>> GetList(Expression<Func<DataBackup, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<DataBackup> SaveData(DataBackup entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<DataBackup>> SaveData(List<DataBackup> entityList)
        {
