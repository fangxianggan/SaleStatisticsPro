...
namespace WebApi.BLL
{
    ...
    ///   业务访问——RoleMenu
    /// </summary>
    public partial class RoleMenuBLL :IRoleMenuBLL
    { 
       private readonly ILogic<RoleMenu> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public RoleMenuBLL(ILogic<RoleMenu> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<RoleMenu> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<RoleMenu>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<RoleMenu>> GetList(Expression<Func<RoleMenu, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<RoleMenu> SaveData(RoleMenu entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<RoleMenu>> SaveData(List<RoleMenu> entityList)
        {
