...
// </auto-generated>
//
// <copyright file="TransferBinBLL.cs">
...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<TransferBin> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public TransferBinBLL(ILogic<TransferBin> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<TransferBin> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<TransferBin>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<TransferBin>> GetList(Expression<Func<TransferBin, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<TransferBin> SaveData(TransferBin entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<TransferBin>> SaveData(List<TransferBin> entityList)
        {
