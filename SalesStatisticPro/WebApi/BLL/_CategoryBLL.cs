...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<Category> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public CategoryBLL(ILogic<Category> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<Category> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Category>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Category>> GetList(Expression<Func<Category, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<Category> SaveData(Category entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<Category>> SaveData(List<Category> entityList)
        {
