...
// </auto-generated>
//
// <copyright file="ExpressCompanyBLL.cs">
...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<ExpressCompany> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public ExpressCompanyBLL(ILogic<ExpressCompany> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<ExpressCompany> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<ExpressCompany>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<ExpressCompany>> GetList(Expression<Func<ExpressCompany, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<ExpressCompany> SaveData(ExpressCompany entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<ExpressCompany>> SaveData(List<ExpressCompany> entityList)
        {
