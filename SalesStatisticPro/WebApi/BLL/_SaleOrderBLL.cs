...
namespace WebApi.BLL
{
    ...
    { 
       private readonly ILogic<SaleOrder> _logic;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="logic"></param>
        public SaleOrderBLL(ILogic<SaleOrder> logic)
        {
           _logic = logic;
        }
        ...
        /// <param name="keyValues"></param>
        /// <returns></returns>
        public HttpReponseModel<SaleOrder> GetModel(params object[] keyValues)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SaleOrder>> GetPageList(QueryModel model)
        {
       ...
       /// <summary>
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SaleOrder>> GetList(Expression<Func<SaleOrder, bool>> whereLambda)
        {
        ...
        /// <returns></returns>
        public HttpReponseModel<SaleOrder> SaveData(SaleOrder entity)
        {
 ...
 return  _logic.UpdateLogic(entity);
        ...
        /// <returns></returns>
        public HttpReponseModel<List<SaleOrder>> SaveData(List<SaleOrder> entityList)
        {
